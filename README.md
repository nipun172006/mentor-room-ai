...
- Mentor personas are approximations created from public material; they do not
  represent or speak for the real educators.
- Answers are generated by an AI model and may be incomplete or incorrect.
  Verify important technical or career guidance independently.
- Prompts are sent to the configured Gemini service. Avoid sharing secrets,
  personal data, or confidential information in chat messages.
- The public Render instance may sleep when idle and take longer to answer its
  first request.
